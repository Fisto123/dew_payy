      ...
      try {
        ...
        const response =
          orgid && dept && dept?.departmentid
            ? await axiosInstance.patch(`/editdepartment/${dept?.departmentid}`, deptValues)
            : orgid && (await axiosInstance.post(`/registerdepartment`, deptValues))
    ...
    <>
      ...
      >
        ...
        >
          ...
          <CCol md={10} className="position-relative">
            <CFormLabel htmlFor="validationTooltip02">Departments name</CFormLabel>
            <CFormInput
              onChange={handleChange}
              name="name"
              type="text"
          ...
          <CCol md={10} className="position-relative">
            <CFormLabel htmlFor="validationTooltipUsername">Companys description</CFormLabel>
            <CInputGroup className="has-validation">
              <CFormTextarea
                ...
                defaultValue={dept && dept?.departmentid ? deptValues?.description : ''}
